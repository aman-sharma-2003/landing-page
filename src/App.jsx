      ...
      <header className="bgRed white">
        ...
        <nav className="flex spaceBetween bold white">
          ...
          <div className="buttons ">
            ...
            <button id="signupBtn" className="red500 bold">Sign Up</button>
          </div>
        </nav>

        <h1 className="textCenter">A modern publishing platform</h1>
        <p className="textCenter"> Grow your audience and build your online brand</p>
        <div className="buttons flex center gap10">
          <button id="startBtn" className="red500 bold">Start for Free</button>
          <button id="learnBtn" className="bold white center">Learn More</button>
        </div>
        </div>
<div><img src="./bg-pattern-intro-desktop.svg" alt="pattern" id="pattern" /></div>
      ...
      <div className="main1 blue900">
        ...
        <div className="flex">
          ...
          <div>
            <img src="./illustration-editor-desktop.svg" alt="editor" id="editor" />
          </div>
        </div>
      </div>
      ...
      <div className="main3">
        <div className="flex">
          <div>
            <img src="./illustration-laptop-desktop.svg" alt="laptop" id="laptop" />
          </div>
